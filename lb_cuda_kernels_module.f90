...
!$acc end host_data
   ...
   attributes(global) subroutine compute_div_theta_n_kernel_nohalo(flop,nx,ny,nz,coords,isfluid, &
     rho_r,rho_b,ntotphifields,ntotauxfields,ntotlocauxfields,phifields_s,auxfields_s,locauxfields_s)
      ...
      myarrx(ii,jj,kk)=auxfields_s(idx5d(ii,jj,kk,5,myblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      myarry(ii,jj,kk)=auxfields_s(idx5d(ii,jj,kk,6,myblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      myarrz(ii,jj,kk)=auxfields_s(idx5d(ii,jj,kk,7,myblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
     ...
     ! Halo Faces
      if(ii==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
	    myarrx(ii-1,jj,kk) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarry(ii-1,jj,kk) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarrz(ii-1,jj,kk) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(ii==TILE_DIMx)then
        iii = i +1
		jjj = j 
      ...
      if(jj==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
	    myarrx(ii,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarry(ii,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarrz(ii,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if (jj==TILE_DIMy) then
        iii = i 
		jjj = j +1
      ...
      if(kk==1) then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
	    myarrx(ii,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarry(ii,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
	    myarrz(ii,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(kk==TILE_DIMz) then
        iii = i 
		jjj = j 
      ...
      if(ii==1 .and. jj==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
        myarrx(ii-1,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarry(ii-1,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarrz(ii-1,jj-1,kk) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(ii==1 .and. jj==TILE_DIMy)then
        iii = i -1
		jjj = j +1
      ...
      if(ii==1 .and. kk==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
        myarrx(ii-1,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarry(ii-1,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarrz(ii-1,jj,kk-1) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(ii==1 .and. kk==TILE_DIMz)then
        iii = i -1
		jjj = j 
      ...
      if(jj==1 .and. kk==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
        myarrx(ii,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarry(ii,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarrz(ii,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(jj==1 .and. kk==TILE_DIMz)then
        iii = i 
		jjj = j -1
      ...
      if(ii==1 .and. jj==1 .and. kk==1)then
		...
		ojj=jjj-oyblock*TILE_DIMy+2*TILE_DIMy
		okk=kkk-ozblock*TILE_DIMz+2*TILE_DIMz
        myarrx(ii-1,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,5,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarry(ii-1,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,6,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
        myarrz(ii-1,jj-1,kk-1) = auxfields_s(idx5d(oii,ojj,okk,7,omyblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nauxfields))
      endif
      if(ii==TILE_DIMx .and. jj==1 .and. kk==1)then
        iii = i +1
		jjj = j -1
      ...
      !div_thetan here
      locauxfields_s(idx5d(ii,jj,kk,2,myblock,TILE_DIMx,TILE_DIMy,TILE_DIMz,nlocauxfields))= &
       (( p1*(myarrx(ii+1,jj,kk)-myarrx(ii-1,jj,kk)) + &
       p2*((myarrx(ii+1,jj+1,kk)-myarrx(ii-1,jj-1,kk))+(myarrx(ii+1,jj-1,kk)-myarrx(ii-1,jj+1,kk))+ &
       (myarrx(ii+1,jj,kk+1)-myarrx(ii-1,jj,kk-1))+(myarrx(ii+1,jj,kk-1)-myarrx(ii-1,jj,kk+1)))+ &
       p3*((myarrx(ii+1,jj+1,kk+1)-myarrx(ii-1,jj-1,kk-1))+(myarrx(ii+1,jj-1,kk-1)-myarrx(ii-1,jj+1,kk+1))+ &
       (myarrx(ii+1,jj-1,kk+1)-myarrx(ii-1,jj+1,kk-1))+(myarrx(ii+1,jj+1,kk-1)-myarrx(ii-1,jj-1,kk+1))))+ &
       (p1*(myarry(ii,jj+1,kk)-myarry(ii,jj-1,kk)) + &
       p2*((myarry(ii+1,jj+1,kk)-myarry(ii-1,jj-1,kk))+(myarry(ii-1,jj+1,kk)-myarry(ii+1,jj-1,kk))+ &
       (myarry(ii,jj+1,kk+1)-myarry(ii,jj-1,kk-1))+(myarry(ii,jj+1,kk-1)-myarry(ii,jj-1,kk+1)))+ &
       p3*((myarry(ii+1,jj+1,kk+1)-myarry(ii-1,jj-1,kk-1))+(myarry(ii-1,jj+1,kk-1)-myarry(ii+1,jj-1,kk+1))+ &
       (myarry(ii+1,jj+1,kk-1)-myarry(ii-1,jj-1,kk+1))+(myarry(ii-1,jj+1,kk+1)-myarry(ii+1,jj-1,kk-1))))+ &
       (p1*(myarrz(ii,jj,kk+1)-myarrz(ii,jj,kk-1)) + &
       p2*((myarrz(ii+1,jj,kk+1)-myarrz(ii-1,jj,kk-1))+(myarrz(ii-1,jj,kk+1)-myarrz(ii+1,jj,kk-1))+ &
       (myarrz(ii,jj+1,kk+1)-myarrz(ii,jj-1,kk-1))+(myarrz(ii,jj-1,kk+1)-myarrz(ii,jj+1,kk-1)))+ &
       p3*((myarrz(ii+1,jj+1,kk+1)-myarrz(ii-1,jj-1,kk-1))+(myarrz(ii-1,jj-1,kk+1)-myarrz(ii+1,jj+1,kk-1))+ &
       (myarrz(ii+1,jj-1,kk+1)-myarrz(ii-1,jj+1,kk-1))+(myarrz(ii-1,jj+1,kk+1)-myarrz(ii+1,jj-1,kk-1)))))*invcssq
      
      return
      
   endsubroutine compute_div_theta_n_kernel_nohalo
